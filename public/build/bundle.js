    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(link, file, 41, 2, 2127);
    			...
    			add_location(img, file, 46, 6, 2275);
    			add_location(div0, file, 46, 1, 2270);
    			attr_dev(input, "type", "text");
    			add_location(input, file, 49, 26, 2416);
    			add_location(p0, file, 49, 3, 2393);
    			attr_dev(p1, "class", "logentry");
    			add_location(p1, file, 50, 3, 2467);
    			add_location(button, file, 51, 6, 2522);
    			add_location(p2, file, 51, 3, 2519);
    			add_location(b, file, 53, 34, 2609);
    			add_location(h2, file, 53, 59, 2634);
    			add_location(div1, file, 53, 3, 2578);
    			attr_dev(div2, "class", "border-5");
    			add_location(div2, file, 48, 2, 2365);
    			add_location(div3, file, 47, 1, 2356);
    			attr_dev(div4, "class", "center svelte-fk5kae");
    			add_location(div4, file, 45, 0, 2247);
    			attr_dev(main, "class", "svelte-fk5kae");
    			add_location(main, file, 44, 0, 2239);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
